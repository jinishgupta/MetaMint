...
function LoginPage() {
    ...
    return(
        ...
        <div
          className="w-full max-w-[450px] p-12 md:p-10 sm:p-8 bg-[rgba(22,23,27,0.8)] backdrop-blur-2xl border border-glass-border rounded-2xl shadow-xl relative overflow-hidden flex flex-col justify-center transition-all animate-slideInUp"
          style={{ boxShadow: '0 0 50px rgba(0,220,130,0.1)' }}
        > 
          <div className="shimmer-line" />
          <div className="login-form text-center w-full relative z-[1]">
            <h1 className="text-[3.5rem] md:text-[2.8rem] sm:text-[2.4rem] mb-4 font-black bg-accent-gradient bg-clip-text text-transparent tracking-tight animate-fadeInUp" style={{ WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Welcome Back</h1>
            <p className="subtitle text-[1.2rem] md:text-[1.1rem] sm:text-[1rem] text-text-secondary mb-12 md:mb-10 sm:mb-8 font-medium animate-fadeInUp">Please log in to your account</p>
