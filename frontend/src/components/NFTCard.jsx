import MintbitNFT from '../assets/sample3.jpg';
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center flex-1 p-2">
          ...
          <div className="text-base font-bold mb-2 bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text">Jinish</div>
          <div className="text-white text-sm">Price</div>
          <div className="text-base font-bold bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text">0.0001 ETH</div>
        </div>
      </div>
      )
}
