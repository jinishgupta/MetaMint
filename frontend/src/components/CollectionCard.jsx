  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center flex-1 p-2">
        ...
        <div className="text-base font-bold mb-2 bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text">{floor} ETH</div>
        <div className="text-white text-sm">Total Volume</div>
        <div className="text-base font-bold bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text">{volume} ETH</div>
      </div>
    </div>
  );
}
